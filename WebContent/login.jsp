...
<input type="text" class="inputAttr1" required="required" name="user" placeholder="请输入用户名"/>
<br/>
<input type="password" class="inputAttr2" required="required" name="pass" placeholder="请输入密码"/>
<br/>
<input type="submit" class="login_button" value="登陆"/>
<input type="button" class="login_button" value="注册" onclick='window.open("register.jsp")'/>
</form>
</div>
</body>
</html>
